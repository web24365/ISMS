...
class Department(models.Model):
	...
	class Meta:
        ...
        desc=models.CharField(verbose_name=u'직무', max_length = 50)
...
#        outlines=models.CharField(verbose_name=u'개요', max_length=10)
...
class Staff(models.Model):
	...
	class Meta:
        ...
        staff_duty=models.CharField(max_length = 30, verbose_name=u'직무')
...
class Risk_mgmt(models.Model):
	...
	action_code=models.CharField(verbose_name=u'위험 코드', max_length = 20)
	action_desc=models.TextField(verbose_name=u'위험 관리')
...
class Threat(models.Model):
	...
	threat_class=models.CharField(verbose_name=u'위협 분류', max_length = 50)
	threat_type=models.CharField(verbose_name=u'위협 유형', max_length = 50)
	threat_entry=models.CharField(verbose_name=u'위협 내용', max_length = 50)
	threat_scenario=models.TextField(verbose_name=u'위협 시나리오')
	threat_impact=models.CharField(verbose_name=u'위협 강도', max_length = 10)
	threat_frequency=models.CharField(verbose_name=u'발생 빈도', max_length = 10)
...
class Risk_control(models.Model):
	...
	risk_mgmt_code = models.ForeignKey(Risk_mgmt, verbose_name=u'위험 분석 코드')
